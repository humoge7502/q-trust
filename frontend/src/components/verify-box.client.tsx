...
export function VerifyBox() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/15 bg-white/[0.07] p-5 shadow-2xl backdrop-blur-xl sm:p-6">
      ...
      <p id="verify-help" className="relative mt-3 text-[11px] leading-relaxed text-slate-400">Paste a full asset ID or <button type="button" onClick={() => setValue(EXAMPLE_ASSET_ID)} className="text-slate-300 underline decoration-slate-600 underline-offset-4 hover:text-white">use the example</button>. No wallet required.</p>
