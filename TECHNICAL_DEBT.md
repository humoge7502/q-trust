...
| TD-06 | Frontend has no automated Lighthouse/CWV budget in CI | Perf regressions would ship silently | Playwright covers function+a11y, not perf | Add `@playwright/test`-driven Lighthouse assertion (LCP < 2.5s) to the existing e2e job | P3 |
